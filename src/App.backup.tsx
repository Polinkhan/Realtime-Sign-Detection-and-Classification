...
import { detect, detectVideo } from "./app/utils/detect";
import Loader from "./app/components/loader";
import ButtonHandler from "./app/components/btn-handler";
...
const App = () => {
  ...
  // model configs
  const modelName = "detection";

  useEffect(() => {
    tf.ready().then(async () => {
      const yolov8 = await tf.loadGraphModel("detection_web_model/model.json", {
